...
patch_googlephotos() {
	...
	get_apk "com.google.android.apps.photos" "google-photos" "photos" "google-inc/photos"
...
patch_soundcloud() {
	...
	get_apk "com.soundcloud.android" "soundcloud" "soundcloud-soundcloud" "soundcloud/soundcloud-soundcloud/	" "Bundle_extract"
