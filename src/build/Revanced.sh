...
patch_googlephotos() {
	...
	get_apk "google-photos" "google-inc/photos"
...
patch_soundcloud() {
	...
	# Download latest version with correct parameter order
	get_apk "soundcloud" "soundcloud/soundcloud-soundcloud" "bundle" "arm64-v8a"
	...
	split_arch "soundcloud" "revanced" "$rip_libs $rip_dpi"
	
	# Rename the final output file
	mv ./release/soundcloud.apk ./release/soundcloud-revanced.apk
}
